...
# Входной вектор x (INPUT DIM), измерения лепестков (длина, ширина, длина лепистка, ширина лепистка)
x = np.array([7.9, 3.1, 7.5, 1.8])

# Матрица весов 1, получается за счет обучения
...
# Кол-во смещения нейронов для первой матрицы
b1 = np.array(
...
# Кол-во смещения нейронов для второй матрицы
b2 = np.array([-0.16286677, 0.06680119, -0.03563594])


# Находит максимум из значений в векторе t
def relu(t):
...
# Индекс максимума из результируещего веткора
